...
<script>
  ...
  methods:{
    checkForm:function(e) {
      ...
      this.form.errors = [];
      if(!this.form.firstname) this.form.errors.push("First name required.");
      if(!this.form.lastname) this.form.errors.push("Last name required.");
      e.preventDefault();
    }
  }
  } 
...
<style>
  ...
  * {
  ...
  body {
    min-height: 100vh;
    background: linear-gradient(to bottom, #F27777, #F27777)
